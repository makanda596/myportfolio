      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center mb-4">
          <input
            ...
            className="w-full max-w-md p-1 border rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-teal-500"
          />
        </div>
        ...
        {filteredProjects.length > 0 ? (
          <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4">
            {filteredProjects.map((item, index) => (
              <div
                key={index}
                className="cursor-pointer bg-white rounded-sm shadow-md overflow-hidden border border-gray-200 hover:shadow-xl transition duration-300"
                  ...
                  <div className="flex gap-2 overflow-x-auto px-3 py-2 bg-gray-100">
                    {item.images.slice(1).map((imgSrc, i) => (
                      <img
                        ...
                        src={imgSrc}
                        alt={`Thumbnail ${i + 1}`}
                        className="w-12 h-12 object-contain rounded-lg border border-black-400 hover:border-teal-500"
                        onClick={(e) => {
                          e.stopPropagation();
                          openModal(item, i + 1);
                        }}
        ...
        {selectedProject && (() => {
          ...
          return (
            ...
            >
              <div
                className="relative w-full max-w-xl bg-white rounded-xl shadow-xl p-2 first-letter:md:p-4 max-h-[90vh] overflow-y-auto"
                ...
                <div className="flex flex-col items-center justify-center gap-2">
                  <div className="flex items-center justify-center gap-2 w-full">
                    <button
                      ...
                      className="text3xl bg-black font-bold text-teal-600 hover:text-teal-800 disabled:text-gray-400"
                    >
                      &#8592;
                    </button>
