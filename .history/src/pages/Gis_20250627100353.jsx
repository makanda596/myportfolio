...
const Gis = () => {
  ...
  const openModal = (project, imageIndex = 0) => {
    ...
    setShowFullDesc(false); // Reset description toggle on open
              ...
              >
                ...
                <p className="mt-6 text-gray-700 text-lg leading-relaxed">
                  {showFullDesc
                    ...
                    : truncate(selectedProject.desc, 300)}
                </p>

                {selectedProject.desc.length > 300 && (
                  <button
                    onClick={() => setShowFullDesc(!showFullDesc)}
                    className="mt-2 text-teal-600 hover:text-teal-800 font-semibold focus:outline-none"
                  >
