    ...
    <>
      ...
      <section className="min-h-screen bg-gray-50 py-16 px-2">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-teal-700 mb-6">GIS Projects</h2>
              ...
              {filteredProjects.map((item, index) => (
                ...
                >
                  ...
                  {item.images?.length > 1 && (
                    <div className="flex overflow-x-auto px-3 py-2 bg-gray-100">
                      {item.images.slice(1).map((img, i) => (
                        <img
                          ...
                          className="w-14 h-14 object-cover rounded-md mr-2 border hover:border-teal-500"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm text-gray-600">{truncate(item.desc, 100)}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            return (
              ...
              >
                ...
                >
                    ...
                    <div className="flex gap-2 overflow-x-auto px-2">
                      {images.map((img, i) => (
                        <img
                          ...
                          className={`w-16 h-16 object-cover rounded cursor-pointer border-2 ${i === currentImageIndex
                            ? 'border-teal-600'
                            : 'border-gray-300'
                            }`}
                        />
                  ...
                  <div className="mt-6 text-gray-700 text-sm sm:text-base leading-relaxed whitespace-pre-line">
