        ...
        <nav className="bg-gray-600 text-white py-2 px-4 fixed w-full z-10">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-8">
                    ...
                    <div>
                        <a href="/gisprojects" className="flex items-center space-x-2 hover:text-blue-400">
                            <FaProjectDiagram /> <span>GIS Projects</span>
                        </a>
                    </div>
                    <div>
            ...
            {isOpen && (
                <div className="md:hidden flex flex-col items-center space-y-2 mt-4">
                    ...
                    <a href="#services" className="text-white hover:text-blue-400">My services</a>
                    <a href="#skills" className="text-white hover:text-blue-400">Skills</a>
                    <a href="/gisprojects" className="text-white hover:text-blue-400">Gis Projects</a>
