...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            >
                <img src="" alt="Your Profile" className="w-full h-full object-cover" />
            </motion.div>
            ...
            >
                Hi, I'm <span className="text-teal-300">{/* Highlight your name or role */}BRIAN MAKANDA</span>
            </motion.h1>
            ...
            >
                Undergraduate at Moi University,persuing BACHELOR OF ARTS PURE GEOGRAPHY(GEOSPATIAL ENGENEERING) and passionate about <span className="text-yellow-300">GIS, Remote Sensing & Geospatial Engineering</span>, and a <span className="text-purple-300">Full-Stack Developer</span> since 2023. Based in Kenya <FaMapMarkerAlt className="inline-block ml-1" />.
            </motion.p>
            ...
            >
                <motion.a
                    href="#about" // Link to your projects section
                ...
                >
                    <a href='#about'><FaCode className="mr-2" /> Explore Projects</a> 
                </motion.a>
                <motion.a
