...
const About = () => (
    ...
    >
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto px-2">
            {[
                {
                    icon: <FaMapMarkedAlt />,
                    title: 'GIS & Mapping',
                ...
                <motion.div
                    ...
                    className="bg-white rounded-xl shadow-lg py-2 text-center border-t-4 border-teal-500 hover:shadow-xl transition duration-300"
                >
                    <div className="text-4xl text-teal-600 mb-4 align-items: center;">{item.icon}</div>
