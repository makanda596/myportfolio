...
import ProfileImage from '../assets/profile-picture.jpg'; // Import your image

const Hero = () => {
    return (
        <section className="relative py-20 md:py-32 bg-gradient-to-br from-gray-900 to-black text-white overflow-hidden">
