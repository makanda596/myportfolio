...
import { SiTailwindcss, SiJavascript, SiMongodb, SiRedis, SiGoogleearth, SiExpress, SiLeaflet, SiQgis, SiArcgis } from 'react-icons/si';
            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h3 className="text-xl font-semibold mb-4 text-yellow-300">Frontend</h3>
