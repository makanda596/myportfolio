    ...
    return (
        ...
        >
            ...
            >
                ...
                <motion.a
                    href="../assets/BRIAN MAKANDA RESUME.pdf"
                    download="BRIAN_MAKANDA_Resume"
                    className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 px-6 rounded-full shadow-md transition duration-300 ease-in-out"
                    variants={socialVariants}
                >
                    Download Resume
                </motion.a>
