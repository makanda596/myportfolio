...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            >
                Undergraduate at Moi University,PERSUING BACHELOR OF ARTS PURE GEOGRAPHY(GEOSPATIAL ENGENEERING) passionate about <span className="text-yellow-300">GIS, Remote Sensing & Geospatial Engineering</span>, and a <span className="text-purple-300">Full-Stack Developer</span> since 2023. Based in Kenya <FaMapMarkerAlt className="inline-block ml-1" />.
            </motion.p>
