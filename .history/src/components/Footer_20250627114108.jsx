    ...
    return (
      <footer className="bg-gray-800 text-white py-10">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 mb-4">
              Passionate Frontend & Backend Developer with a love for geospatial and remote sensing projects.
            </p>
        ...
        <div className="border-t border-gray-700 mt-10 pt-4 text-center text-sm text-gray-400">
          ...
          Designed & Built with ❤️ by <span className="text-white font-semibold">Brian Makanda</span>
        </div>
      </footer>
    );
  };
