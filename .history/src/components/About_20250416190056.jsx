...
const About = () => (
    <section id="about" className="py-20 px-6 max-w-6xl mx-auto bg-white text-gray-800">
        <motion.h2
        ...
        <motion.div
            ...
            viewport={{ once: true }}
            className="text-lg text-gray-600 leading-8 mb-12 space-y-6 text-center max-w-3xl mx-auto"
        >
            <span className="text-green-600 font-semibold"> GIS & Remote Sensing student</span> at Moi University.
            <p>
                 Hey! I'm a self-taught <span className="text-blue-600 font-semibold">Full-Stack Developer</span> and a passionate
            </p>
