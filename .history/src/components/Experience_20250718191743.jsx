...
export default function Experience() {
  ...
  return (
    <section className="py-10 px-4 bg-gradient-to-br from-gray-900 to-gray-800 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <div className="w-32 h-1 bg-gradient-to-r from-cyan-500 to-blue-600 mx-auto mb-4 rounded-full"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {experiences.map((exp, idx) => (
            ...
            >
              ...
              {/* Card content */}
              <div className="relative bg-gray-800 bg-opacity-70 backdrop-blur-lg border border-gray-700 rounded-3xl p-8 h-full">
