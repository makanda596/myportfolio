...
const backendProjects = [
  {
    name: "UniTrade Hub",
    description: " Hello Born out of the need to simplify trade among Moi University students, Unitrade Hub is a project that connects comrades with local sellers—making it easier to buy, sell, and support each other within the campus community.",
