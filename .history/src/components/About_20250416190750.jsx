...
const About = () => (
    <section id="about" className="py-10 px-6 max-w-6xl mx-auto bg-white text-gray-800">
        ...
        <motion.div
            ...
            viewport={{ once: true }}
            className="text-lg text-gray-600 leading-8 mb-2 space-y-2 text-center max-w-3xl mx-auto"
        ><p>
                <span className="text-green-600 font-semibold">I am a Final Undegraduate student Persuing Bachelor Of arts (GEOGRAPHY) </span> at Moi University.
                  ...
                  self-taught <span className="text-blue-600 font-semibold">Full-Stack Developer (FRONTEND DEVELOPER & BACKEND DEVELOPER)</span> 
            </p>
        ...
        <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-6">
            ...
            <motion.div whileHover={{ scale: 1.05 }} className="bg-gray-100 p-6 rounded-xl shadow-md text-center">
                ...
                <p className="text-sm text-gray-700">
                    Developed the GESSAMU Portal,A start Company UniTrade Hub, photography sites, and multiple data-driven platforms.
                </p>
            </motion.div>
        </div>
    </section>
