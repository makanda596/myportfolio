...
export default function Experience() {
  ...
  return (
    <section id="experience"className="py-2 px-4 bg-gradient-to-br from-gray-900 to-gray-800 relative overflow-hidden">
      {/* Decorative elements */}
              ...
              <div className="relative bg-gray-800 bg-opacity-70 backdrop-blur-lg border border-gray-700 rounded-3xl p-4 h-full">
                <div className="flex flex-col h-full">
                  ...
                  <div className="mb-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.skills.map((skill, i) => (
                        <span
                          key={i}
                          className="bg-gray-700 text-cyan-300 px-4 py-1 rounded-full text-sm font-medium"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div className="mt-auto">
                    ...
                    >
                      <div className="bg-gradient-to-r from-cyan-500 to-blue-600 p-2 rounded-lg mr-3 group-hover:scale-110 transition-transform">
