...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            <motion.p
                variants={textVariants}
                className="mt-2 text-lg md:text-xl max-w-2xl text-gray-700 leading-relaxed"
            >
                Final year undergraduate at Moi University, pursuing <strong>Pure Geography (Geospatial Engineering)</strong>.
                Passionate about <span className="text-teal-500 font-medium">GIS, Remote Sensing</span> & <span className="text-teal-500 font-medium">Full-Stack Development</span>. Based in Kenya.
            </motion.p>
            ...
            >
                <motion.a
                    href="#projects"
                    className="bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-6 rounded-full flex items-center gap-2 shadow-md transition duration-300"
