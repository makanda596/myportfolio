...
const About = () => (
    <section
        id="about"
        className="py-10 px-6 bg-gradient-to-br from-white via-gray-50 to-teal-50 text-gray-800"
    >
        <motion.h2
        ...
        <motion.div
            ...
            viewport={{ once: true }}
            className="text-lg text-gray-700 leading-8 mb-12 text-center max-w-3xl mx-auto space-y-4"
        >
            <p>
                I’m a multi-skilled professional with a strong background in{' '}
                <span className="text-teal-800 font-semibold">
                    Geospatial Analysis, Remote Sensing, and Full-Stack Development
                </span>
                .
            </p>
            <p>
