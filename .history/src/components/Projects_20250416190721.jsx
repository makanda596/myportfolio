...
const backendProjects = [
  ...
  },
  {
    name: "UniTrade Hub",
    description:
      "I am a founder of the Unitrade Hub Startup, platform connecting Moi University students and sellers to buy and sell goods easily within the campus environment.",
